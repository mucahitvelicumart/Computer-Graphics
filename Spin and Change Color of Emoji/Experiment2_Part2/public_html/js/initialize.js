...
var scale = 0.4;
var face_radius = 0.50*scale;  //Radius of face for drawing circle
...
var eyes_radius = 0.075 * scale; //Radius of eyes for drawing circle
var eyes_circle_centers = [[0.15* scale,0.175* scale],[-0.15* scale,0.175* scale]];// Centers of Circles of Eyes
...
var strings_of_mask = [
    [-0.50* scale, 0.025* scale,-0.30* scale, -0.025* scale,-0.50* scale, -0.025* scale,-0.30* scale, -0.075* scale],             //Left-Up String
    [0.50* scale, 0.025* scale,0.30* scale, -0.025* scale,0.50* scale, -0.025* scale,0.30* scale, -0.075* scale],                 //Right-Up String
    [-0.341* scale, -0.365* scale,-0.30* scale, -0.35* scale,-0.371* scale, -0.335* scale,-0.30* scale, -0.31* scale],            //Left-Down String
    [0.341* scale, -0.365* scale,0.30* scale, -0.35* scale,0.371* scale, -0.335* scale,0.30* scale, -0.31* scale]                 //Right-Down String
];

//Positions of Mask Square
var mask = [-0.30* scale, -0.025* scale,0.30* scale, -0.025* scale,-0.30* scale, -0.35* scale,0.30* scale, -0.35* scale];


//P0,P1,P2 are points for Bezier Curve Calculations
var p0 = {x:-0.30* scale,y:-0.025* scale}; 
var p1 = {x:0.0* scale,y:0.125* scale};
var p2 = {x:0.30* scale,y:-0.025* scale};
...
var p0_1 = {x:-0.30* scale,y:-0.35* scale}; 
var p1_1 = {x:0.0* scale,y:-0.5* scale};
var p2_1 = {x:0.30* scale,y:-0.35* scale};
